 ...
 * this class instead.
 */
public class CheckOutBuildingResponse implements ASObjectable {
public Double packageId = null;
public String msg = null;
public ConditionBean conditionBean = null;
public String errorMsg = null;
public Integer ok = null;

public CheckOutBuildingResponse(ASObject aso) {
...
public CheckOutBuildingResponse() {
}

@Override
public CheckOutBuildingResponse clone() {
CheckOutBuildingResponse clone = new CheckOutBuildingResponse();
