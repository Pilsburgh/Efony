...
*/
public class RankCastleResponse implements ASObjectable {
public Double packageId = null;
public String msg = null;
public Integer pageNo = null;
public ArrayList<CastleBean> beans = null;
public Integer pageSize = null;
public String errorMsg = null;
public Integer totalPage = null;
public Integer ok = null;

public RankCastleResponse(ASObject aso) {
beans = new ArrayList<CastleBean>();
...
beans.add(new CastleBean((ASObject) objArr[j]));
}
}
...
public RankCastleResponse() {
}

@Override
public RankCastleResponse clone() {
RankCastleResponse clone = new RankCastleResponse();
