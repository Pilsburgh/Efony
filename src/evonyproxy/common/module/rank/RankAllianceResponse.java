package evonyproxy.common.module.rank;
 ...
 * this class instead.
 */
public class RankAllianceResponse implements ASObjectable {
public Double packageId = null;
public String msg = null;
public Integer pageNo = null;
public ArrayList<RankAllianceBean> beans = null;
public Integer pageSize = null;
public String errorMsg = null;
public Integer totalPage = null;
public Integer ok = null;

public RankAllianceResponse(ASObject aso) {
beans = new ArrayList<RankAllianceBean>();
...
beans.add(new RankAllianceBean((ASObject) objArr[j]));
}
}
...
public RankAllianceResponse() {
}

@Override
public RankAllianceResponse clone() {
RankAllianceResponse clone = new RankAllianceResponse();
