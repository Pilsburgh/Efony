 ...
 * this class instead.
 */
public class RankPlayerResponse implements ASObjectable {
public Double packageId = null;
public String msg = null;
public Integer pageNo = null;
public ArrayList<PlayerInfoBean> beans = null;
public Integer pageSize = null;
public String errorMsg = null;
public Integer totalPage = null;
public Integer ok = null;

public RankPlayerResponse(ASObject aso) {
beans = new ArrayList<PlayerInfoBean>();
...
beans.add(new PlayerInfoBean((ASObject) objArr[j]));
}
}
...
public RankPlayerResponse() {
}

@Override
public RankPlayerResponse clone() {
RankPlayerResponse clone = new RankPlayerResponse();
