...
*/
public class WantedAllianceResponse implements ASObjectable {
...
public WantedAllianceResponse(ASObject aso) {
...
public WantedAllianceResponse() {
}

@Override
public WantedAllianceResponse clone() {
WantedAllianceResponse clone = new WantedAllianceResponse();
