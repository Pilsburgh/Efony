...
*/
public class FleeTroopUpdate implements ASObjectable {
public TroopBean troop = null;
public Integer castleId = null;
public Integer goldNeed = null;

public FleeTroopUpdate(ASObject aso) {
...
public FleeTroopUpdate() {
}

@Override
public FleeTroopUpdate clone() {
FleeTroopUpdate clone = new FleeTroopUpdate();
