...
public class EvonyClient extends AbstractEvony {
    ...
    EvonyClient(IO io, Socket s, boolean verbose) {
        super(io, s, verbose);
        primaryConnection = false;
    }

    EvonyClient(boolean primaryConnection, IO io, Socket s, boolean verbose) {
        super(io, s, verbose);
        this.primaryConnection = primaryConnection;
        initializeVars();
    }

    EvonyClient(IO io, Socket socket) {
        super(io, socket);
        primaryConnection = false;
    }

    EvonyClient(boolean primaryConnection, IO io, Socket s) {
        super(io, s);
        this.primaryConnection = primaryConnection;
    }
    ...
    EvonyClient(IO io, boolean verbose) {
        super(io, verbose);
        primaryConnection = false;
    }
